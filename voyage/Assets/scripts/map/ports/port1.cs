...
{
    public static int firstarrivalsingapore = 0;
    ...
    void Update()
    {
        ...
        if (port1.firstarrivalsingapore == 1 && sail.arrival == 1 && sail.portarrival == 1)
        {
            if (initiate == true)
            {
            ...
            if (timer < 0)
            {
                ...
                SceneManager.LoadScene("Singapore");
                port1.firstarrivalsingapore = 0;
