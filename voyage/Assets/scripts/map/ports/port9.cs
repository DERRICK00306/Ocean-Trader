...
public class port9 : MonoBehaviour
{
    public static int firstarrivalbar = 0;
    ...
    void Update()
    {
        ...
        if (port9.firstarrivalbar == 1 && sail.arrival == 1 && sail.portarrival == 9)
        {
            if (initiate == true)
            {
