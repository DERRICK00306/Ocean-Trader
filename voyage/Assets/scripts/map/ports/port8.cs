...
public class port8 : MonoBehaviour
{
    public static int firstarrivalham = 0;
    ...
    void Update()
    {
        ...
        if (port8.firstarrivalham == 1 && sail.arrival == 1 && sail.portarrival == 8)
        {
            if (initiate == true)
            {
            ...
            if (timer < 0)
            {
                ...
                SceneManager.LoadScene("Hamburg");
                port8.firstarrivalham = 0;
