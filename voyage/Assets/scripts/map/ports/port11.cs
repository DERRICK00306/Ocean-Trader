...
public class port11 : MonoBehaviour
{
    public static int firstarrivalven = 0;
    ...
    void Update()
    {
        ...
        if (port11.firstarrivalven == 1 && sail.arrival == 1 && sail.portarrival == 11)
        {
            if (initiate == true)
            {
