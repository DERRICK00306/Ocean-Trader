...
public class port3 : MonoBehaviour
{
    public static int firstarrivalsydney = 0;
    ...
    void Update()
    {
        ...
        if (port3.firstarrivalsydney == 1 && sail.arrival == 1 && sail.portarrival == 3)
        {
            if (initiate == true)
            {
