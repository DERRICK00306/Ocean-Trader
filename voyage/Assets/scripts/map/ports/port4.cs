...
{
    public static int firstarrivalgood = 0;
    ...
    void Update()
    {
        ...
        if (port4.firstarrivalgood == 1 && sail.arrival == 1 && sail.portarrival == 4)
        {
            if (initiate == true)
            {
            ...
            if (timer < 0)
            {
                ...
                SceneManager.LoadScene("Good_Hope");
                port4.firstarrivalgood = 0;
