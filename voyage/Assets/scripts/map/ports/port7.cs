...
public class port7 : MonoBehaviour
{
    public static int firstarrivallondon = 0;
    ...
    void Update()
    {
        ...
        if (port7.firstarrivallondon == 1 && sail.arrival == 1 && sail.portarrival == 7)
        {
            if (initiate == true)
            {
