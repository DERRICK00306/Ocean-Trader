...
public class port12 : MonoBehaviour
{
    public static int firstarrivalsan = 0;
    ...
    void Update()
    {
        ...
        if (port12.firstarrivalsan == 1 && sail.arrival == 1 && sail.portarrival == 12)
        {
            if (initiate == true)
            {
            ...
            if (timer < 0)
            {
                ...
                SceneManager.LoadScene("San_Francisco");
                port12.firstarrivalsan = 0;
