...
public class port10 : MonoBehaviour
{
    public static int firstarrivalnew = 0;
    ...
    void Update()
    {
        ...
        if (port10.firstarrivalnew == 1 && sail.arrival == 1 && sail.portarrival == 10)
        {
            if (initiate == true)
            {
            ...
            if (timer < 0)
            {
                ...
                SceneManager.LoadScene("New_York");
                port10.firstarrivalnew = 0;
